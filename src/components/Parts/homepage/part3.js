...
import icon from '/Users/Awesomejoy/web/Rift-platform/Frontend/src/components/images/Frame 1863.png';
import icon1 from '/Users/Awesomejoy/web/Rift-platform/Frontend/src/components/images/Frame 1860.png';
import icon2 from '/Users/Awesomejoy/web/Rift-platform/Frontend/src/components/images/Frame 1858.png';
            ...
            <div className = 'section-3H'>
                ...
                <div className = 'container pt-2 pb-5'>
                    <div className = 'row'>
                        ...
                        <div className ='col-lg-4 col-md-4'>
                            <div className ='text-center text-white'>
                                <img src = {icon2} alt ='icon' className = 'pb-2 how-icon-mob'/>
