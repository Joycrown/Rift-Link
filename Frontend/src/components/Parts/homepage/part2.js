...
import img1 from '../../images/unsplash_5DJ0VvLRSFE.png';
import img2 from '../../images/unsplash_GzumspFznSE.png';
import img3 from '../../images/unsplash_46oLPhFNof8.png';
import img4 from '../../images/unsplash_jJFrkJP_-RA.png';
import icon from '../../images/Frame 10.png';
import icon1 from '../../images/Frame 11.png';
import icon2 from '../../images/Frame 12.png';
import icon3 from '../../images/Frame 13.png';
        ...
        <section className = 'section-2H text center' id=''>
          ...
          <div className = 'img-slide-des'>
            ...
            <div className = 'd-flex justify-content-center pt-5 pb-5'>
                <button type="button" onClick={routeChange} class="sub-btn2 sub-btn2-tab sub-btn2-mob btn btn-info text-white text-center">START YOUR 14 DAYS FREE TRAIL</button>
            </div>
            {/* 1 */}
            {/* Desktop */}
            <section id= 'About'>
                    ...
                    <div className = 'container'>
                        ...
                        <div className = 'd-flex pt-3'>
                            ...
                            <div className = 'ps-3'>
                                ...
                                <p className = 'info-text-mob'>
                                    Lightening fast copy speed with low 
                                    latency, sophiscated risk management protocol
